...
// that Rust allows us to create aliases. Conveniently, we can define one for
// the specific Result in question.
//
...
// can succinctly define all associated Results. This is so useful that the std
