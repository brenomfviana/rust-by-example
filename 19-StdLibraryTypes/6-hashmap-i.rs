// Where vectors store values by an integer index, HashMaps store values by
...
// when they have excess space. You can create a HashMap with a certain
// starting capacity using HashMap::with_capacity(uint), or use HashMap::new()
