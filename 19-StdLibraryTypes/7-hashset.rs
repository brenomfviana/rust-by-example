...
// But sets can do more than that. Sets have 4 primary operations (all of the
// following calls return an iterator):
...
fn main() {
  ...
  // This should print [1]
  println!("Difference a - b: {:?}", a.difference(&b).collect::<Vec<&i32>>());
  println!("Difference b - a: {:?}", b.difference(&a).collect::<Vec<&i32>>());
